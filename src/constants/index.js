...
export const ABOUT_TEXT = `I am a dedicated and versatile full stack developer with a passion for creating efficient and user-friendly web applications. With 1–2 years of Hands-on experience, I have worked with technologies such as React, Node.js, MySQL, and MongoDB. My journey in web development began with a deep curiosity for how things work, and it has evolved into a career where I continuously strive to learn and adapt to new challenges. I thrive in collaborative environments and enjoy solving complex problems to deliver high-quality solutions. I have also gained hands-on experience through hackathons, including HackByte 2.0 at IIIT Jabalpur, where our team "Code Hack" built and iterated rapidly in a 36-hour challenge, and Hackfest ’24 at IIT Dhanbad, where my team "Access Denied" was selected as one of 70 finalists out of 270+ submissions. These experiences sharpened my problem-solving, teamwork, and innovation skills while making unforgettable memories with peers across the tech community.
`;
